...
var getColors = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _productService["default"].handleGetColors();
          case 2:
            data = _context3.sent;
  ...
  return function getColors(_x5, _x6) {
...
var countProducts = /*#__PURE__*/function () {
  ...
  return function countProducts(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var createCatalogOption = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return _productService["default"].handleCreateCatalogOption(req.body);
          case 2:
            data = _context5.sent;
            return _context5.abrupt("return", res.status(data.code === _constant.ResponseCode.SUCCESS ? 200 : 400).json(data));
          case 4:
          case "end":
  ...
  return function createCatalogOption(_x9, _x0) {
    return _ref5.apply(this, arguments);
  };
}();
var updateCatalogOption = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return _productService["default"].handleUpdateCatalogOption(req.body);
          case 2:
            data = _context6.sent;
            return _context6.abrupt("return", res.status(data.code === _constant.ResponseCode.SUCCESS ? 200 : 400).json(data));
          case 4:
          case "end":
  ...
  return function updateCatalogOption(_x1, _x10) {
    return _ref6.apply(this, arguments);
  };
}();
var deleteCatalogOption = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return _productService["default"].handleDeleteCatalogOption(req.body);
          case 2:
            data = _context7.sent;
            return _context7.abrupt("return", res.status(data.code === _constant.ResponseCode.SUCCESS ? 200 : 400).json(data));
          case 4:
          case "end":
  ...
  return function deleteCatalogOption(_x11, _x12) {
...
var getProduct = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var _req$query, slug, product_id, id, categories, materials, colors, page, _data, data;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _req$query = req.query, slug = _req$query.slug, product_id = _req$query.product_id, id = _req$query.id, categories = _req$query.categories, materials = _req$query.materials, colors = _req$query.colors, page = _req$query.page;
            if (!(slug || product_id || id)) {
              _context8.next = 6;
              break;
            }
            _context8.next = 4;
            return _productService["default"].handleGetProductBy({
              slug: slug,
              id: product_id || id
            });
          case 4:
            _data = _context8.sent;
            return _context8.abrupt("return", res.status(200).json(_data));
          case 6:
            _context8.next = 8;
            return _productService["default"].handleGetProducts({
...
var searchProduct = /*#__PURE__*/function () {
  ...
  return function searchProduct(_x15, _x16) {
...
var createProduct = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context0.prev = _context0.next) {
          case 0:
            ...
            if (!(name && slug && price && brand && category && material && color && quantity && feature_image_url && Array.isArray(images))) {
              _context0.next = 6;
              break;
            }
            _context0.next = 4;
  ...
  return function createProduct(_x17, _x18) {
...
var updateProduct = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context1.prev = _context1.next) {
          case 0:
            ...
            if (!(id && name && slug && price && brand && category && material && color && quantity && feature_image_url && Array.isArray(images))) {
              _context1.next = 6;
              break;
            }
            _context1.next = 4;
  ...
  return function updateProduct(_x19, _x20) {
...
var deleteProduct = /*#__PURE__*/function () {
  ...
  return function deleteProduct(_x21, _x22) {
...
var rollbackImages = /*#__PURE__*/function () {
  ...
  return function rollbackImages(_x23, _x24) {
...
var _default = exports["default"] = {
  ...
  createCatalogOption: createCatalogOption,
  updateCatalogOption: updateCatalogOption,
