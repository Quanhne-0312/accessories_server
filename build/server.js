...
var listen = function listen() {
  return new Promise(function (resolve, reject) {
    var candidate = app.listen(port);
    candidate.once("listening", function () {
      server = candidate;
      resolve();
    });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            exitCode = _args.length > 1 && _args[1] !== undefined ? _args[1] : 0;
            if (!isShuttingDown) {
              _context.next = 3;
              break;
            }
          ...
          case 3:
            isShuttingDown = true;
            console.log("Shutting down server (".concat(reason, ")..."));
            if (!server) {
              _context.next = 8;
              break;
            }
          ...
          case 8:
            _context.next = 10;
            return _models["default"].sequelize.close();
          case 10:
...
startServer()["catch"](/*#__PURE__*/function () {
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            if (error.code === "EADDRINUSE") {
              console.error("Port ".concat(port, " is already in use. Stop the running server before starting a new one."));
            } else {
