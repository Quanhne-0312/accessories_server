...
module.exports = {
  up: function () {
    var _up = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(queryInterface, Sequelize) {
      var now, defaultPasswordHash, _i, _arr, table;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 14:
              _i = 0, _arr = ["roles", "status", "payment_methods", "categories", "materials"];
            case 15:
              if (!(_i < _arr.length)) {
                _context.next = 22;
                break;
              ...
              table = _arr[_i];
              _context.next = 19;
              return queryInterface.sequelize.query("SELECT setval(pg_get_serial_sequence('\"".concat(table, "\"', 'id'), COALESCE(MAX(\"id\"), 1), MAX(\"id\") IS NOT NULL) FROM \"").concat(table, "\";"));
            case 19:
              _i++;
              _context.next = 15;
              break;
